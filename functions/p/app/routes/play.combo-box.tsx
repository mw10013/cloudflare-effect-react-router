...
function OuiExample() {
  return (
    <>
      ...
      <Oui.ComboBoxEx placeholder="Select language">
        <Oui.ListBoxItem>Aardvark</Oui.ListBoxItem>
        <Oui.ListBoxItem>Cat</Oui.ListBoxItem>
        <Oui.ListBoxItem>Dog</Oui.ListBoxItem>
        <Oui.ListBoxItem>Kangaroo</Oui.ListBoxItem>
      ...
      <Oui.ComboBoxEx placeholder="Select a new role">
        <Oui.ListBoxItem textValue="Viewer">
          <Oui.Text slot="label">Viewer</Oui.Text>
          <Oui.Text slot="description">Can view and comment.</Oui.Text>
        </Oui.ListBoxItem>
        <Oui.ListBoxItem>Cat</Oui.ListBoxItem>
        <Oui.ListBoxItem>Dog</Oui.ListBoxItem>
        <Oui.ListBoxItem>Kangaroo</Oui.ListBoxItem>

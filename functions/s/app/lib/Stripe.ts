...
3:28:05 PM [vite] Internal server error: Failed to resolve import "cloudflare:workers" from "app/lib/Stripe.ts". Does the file exist?
  Plugin: vite:import-analysis
  File: /Users/mw/Documents/src/cloudflare-effect-react-router/functions/s/app/lib/Stripe.ts:3:30
  1  |  import { Cloudflare, ConfigEx, ErrorEx } from "@workspace/shared";
  2  |  import { DurableObject } from "cloudflare:workers";
     |                                 ^
  3  |  import { Cause, Config, ConfigError, Effect, Either, Layer, Logger, LogLevel, ManagedRuntime, Option, Predicate, Redacted } from "effect";
  4  |  import { Stripe as StripeClass } from "stripe";

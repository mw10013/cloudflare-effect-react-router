...
- pnpm -F app exec wrangler kv namespace create cloudflare-openauth-stripe-kv-production
- pnpm -F app exec wrangler queues create cloudflare-openauth-stripe-q-production
